...
import logo from '../assets/1000370379.jpg'
const Navbar = () => {
  return (
    <div className='bg-transparent z-20 fixed'>
      <nav className="h-dvh flex flex-col w-16 bg-transparent  ml-2 rounded-xl">
      <img src={logo} alt="" className='w-20 h-20 text-4xl m   bg-inherit' />
      <div className='flex flex-col justify-center items-center bg-transparent flex-1'>
      ...
      <NavLink to='/liked'className='bg-transparent'><Navbarcomp icon={faHeart} name={'LIKED'}></Navbarcomp></NavLink>
