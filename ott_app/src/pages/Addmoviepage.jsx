...
const submitform=(e)=>{
    ...
    toast.success("Movie added sucessful")
    return navigate('/allmovies')
};
...
<form className="max-w-md mx-auto pt-10 text-3xl " onSubmit={submitform}>
    <div className='font-bold  text-center   '>"Craft a Classic:</div>
    <div className='font-bold  text-center   '>Enter the Movie Data!"</div>

  <div className= "text-3xl relative z-0 w-full mb-5 group">
